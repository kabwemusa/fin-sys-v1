<div class="min-h-screen flex items-center justify-center bg-[#071520] px-4">
    <div class="w-full max-w-md">

        {{-- Logo / brand --}}
        <div class="text-center mb-8">
            <div class="inline-flex items-center gap-2 mb-3">
                <div class="w-9 h-9 rounded-xl bg-[#F39C12] flex items-center justify-center">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
                    </svg>
                </div>
                <span class="text-white font-semibold text-lg tracking-tight">Credence Systems</span>
            </div>
            ...
            @if($done)
                ...
                <div class="text-center py-4">
                    ...
                    <a href="{{ route('portal.loans') }}"
                       class="inline-flex items-center gap-2 px-6 py-2.5 bg-[#1B4F72] text-white text-sm font-medium rounded-xl hover:bg-[#2E86C1] transition-colors">
                        Go to my loans
                ...
                <form wire:submit.prevent="submit" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="email" wire:model="email" readonly
                               class="w-full px-4 py-2.5 text-sm text-gray-500 bg-gray-50 border border-gray-200 rounded-xl cursor-not-allowed">
                    ...
                    <div>
                        ...
                        <input type="password" wire:model="password" placeholder="Min 8 characters"
                               class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#1B4F72]/20 focus:border-[#1B4F72] transition-colors @error('password') border-red-300 @enderror">
                    ...
                    <div>
                        ...
                        <input type="password" wire:model="password_confirmation" placeholder="Repeat password"
                               class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#1B4F72]/20 focus:border-[#1B4F72] transition-colors @error('password_confirmation') border-red-300 @enderror">
                        @error('password_confirmation') <p class="text-xs text-red-500 mt-1">{{ $message }}</p> @enderror
                    </div>

                    <button type="submit"
                            wire:loading.attr="disabled"
                            class="w-full py-3 bg-[#1B4F72] text-white text-sm font-semibold rounded-xl hover:bg-[#2E86C1] transition-colors disabled:opacity-60 flex items-center justify-center gap-2">
