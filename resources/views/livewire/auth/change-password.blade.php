<div class="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-16">
    <div class="w-full max-w-sm">
        ...
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-[#1B4F72]/10 mb-4">
                <svg class="w-7 h-7 text-[#1B4F72]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white rounded-3xl shadow-xl shadow-gray-200/60 p-8">
            <form wire:submit.prevent="save" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input wire:model="new_password" type="password" placeholder="Min. 8 characters" autocomplete="new-password"
                            class="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-800 placeholder-gray-400
                ...
                <button type="submit" wire:loading.attr="disabled" wire:loading.class="opacity-70 cursor-not-allowed"
                    class="w-full flex items-center justify-center gap-2 py-3 bg-[#1B4F72] text-white rounded-xl text-sm font-medium
