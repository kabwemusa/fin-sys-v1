...
<div x-data="portalDocumentWorkspace()"
    ...
    <div class="flex flex-wrap items-start justify-between gap-4">
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            @if($application->status === 'info_requested')
                <span class="inline-flex items-center gap-2 rounded-full border border-orange-100 bg-orange-50 px-4 py-2 text-sm font-medium text-orange-600">
    ...
    @if($application->status === 'info_requested' && $application->info_requested_note)
        <div class="portal-panel rounded-3xl border border-orange-100 bg-orange-50 p-5">
            <div class="flex items-start gap-3">
                <svg class="mt-0.5 h-5 w-5 shrink-0 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                </svg>
                <div>
                    <p class="text-sm font-semibold text-orange-700">Additional information required</p>
                    <p class="mt-1 text-sm leading-relaxed text-orange-600">{{ $application->info_requested_note }}</p>
                </div>
            </div>
        </div>
    @endif
            ...
            <div class="portal-panel rounded-3xl overflow-hidden">
                ...
                <div class="grid grid-cols-2 gap-px bg-gray-100 sm:grid-cols-4">
                    <div class="bg-white p-5 text-center">
                        ...
                        <p class="mt-2 text-lg font-semibold text-[#166534]">ZMW {{ number_format($application->amount_requested, 0) }}</p>
                    </div>
                    <div class="bg-white p-5 text-center">
                ...
                <div class="portal-panel rounded-3xl overflow-hidden">
                    <div class="flex items-center justify-between border-b border-gray-100 px-6 py-4">
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-sm font-semibold text-[#166534]">ZMW {{ number_format($application->outstandingBalance(), 2) }}</p>
                        </div>
                    </div>
            ...
            @if($application->status === 'info_requested')
                <div class="portal-panel rounded-3xl overflow-hidden">
                    ...
                    <div class="space-y-4 p-6">
                        <div wire:loading.flex wire:target="uploadDocument" class="items-center gap-3 rounded-2xl border border-[#4EA8D9]/15 bg-[#4EA8D9]/10 px-4 py-3 text-sm text-[#1B4F72]">
                        ...
                        <form wire:submit.prevent="uploadDocument" class="space-y-4">
                            <div>
                                ...
                                <select wire:model="replacement_document_type"
                                        class="w-full rounded-2xl border border-gray-200 px-4 py-3 text-sm text-gray-700 transition-all focus:border-[#166534] focus:outline-none focus:ring-2 focus:ring-[#166534]/10">
                            ...
                            <div>
                                ...
                                <input x-ref="uploadInput"
                                       ...
                                       class="block w-full text-sm text-gray-500 file:mr-4 file:rounded-2xl file:border-0 file:bg-[#166534]/10 file:px-4 file:py-3 file:text-sm file:font-medium file:text-[#166534] hover:file:bg-[#166534]/15">
                                @error('extra_document')
                                    <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                                @enderror
                            </div>

                            <div x-cloak x-show="uploadPreviewUrl" class="rounded-2xl border border-[#4EA8D9]/15 bg-slate-50 p-4">
                                ...
                                <div class="mt-3 flex flex-wrap items-center gap-3">
                                    <button type="button"
                                            ...
                                            class="portal-action inline-flex items-center gap-2 rounded-full border border-[#4EA8D9]/20 bg-[#4EA8D9]/10 px-4 py-2 text-xs font-medium text-[#1B4F72] hover:bg-[#4EA8D9]/15">
                            ...
                            <button type="submit"
                                    ...
                                    class="portal-action inline-flex items-center gap-2 rounded-2xl bg-[#166534] px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-[#166534]/20 transition-all hover:bg-[#14532d]">
