...
<div class="p-6 lg:p-8 max-w-7xl mx-auto space-y-6">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="portal-panel rounded-2xl p-5">
            ...
            <p class="text-2xl font-semibold text-[#E98C00]">ZMW {{ number_format($totalDisbursed, 0) }}</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    @foreach($monthlyStats as $stat)
                        <div class="flex-1 flex flex-col items-center gap-1">
                            <div class="w-full flex flex-col justify-end h-28 gap-0.5">
                                <div class="w-full rounded-t-md bg-linear-to-t from-[#E98C00] to-[#E98C00] transition-all duration-500"
        ...
        <div class="portal-panel rounded-2xl p-6 space-y-4">
            ...
            <a href="{{ route('admin.applications') }}?status=pending" class="portal-action flex items-center justify-between rounded-xl bg-[#FEF9E1] p-3 transition-colors hover:bg-amber-100 group">
            ...
            <a href="{{ route('admin.repayments') }}" class="portal-action flex items-center justify-between rounded-xl bg-[#E98C00]/10 p-3 transition-colors hover:bg-[#E98C00]/15 group">
                <span class="text-sm font-medium text-[#E98C00]">Record Repayment</span>
                <svg class="w-4 h-4 text-[#E98C00]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
            </a>
            <a href="{{ route('admin.products') }}" class="portal-action flex items-center justify-between rounded-xl bg-[#FEF9E1] p-3 transition-colors hover:bg-[#FEF9E1] group">
                <span class="text-sm text-gray-700 font-medium">Manage Products</span>
                <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
            </a>
            <a href="{{ route('admin.reports') }}" class="portal-action flex items-center justify-between rounded-xl bg-[#FEF9E1] p-3 transition-colors hover:bg-[#FEF9E1] group">
    ...
    <div class="portal-panel rounded-2xl overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-50 flex items-center justify-between">
            ...
            <a href="{{ route('admin.applications') }}" class="portal-action text-xs text-[#E98C00] hover:underline">View all →</a>
        </div>
            ...
            <div class="divide-y divide-gray-50">
                @foreach($recentApplications as $app)
                    ...
                    <a href="{{ route('admin.application.review', $app->id) }}"
                       class="portal-card-hover flex items-center justify-between px-6 py-3.5 transition-colors hover:bg-[#FEF9E1] group">
